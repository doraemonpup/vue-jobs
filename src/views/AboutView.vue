  ...
  <section class="bg-green-50">
    <div class="container m-auto max-w-2xl py-24">
      ...
      >
        ...
        rewarding.
        <h2 class="text-l font-semibold mt-6 mb-2">Why Choose Us?</h2>
        <ul class="pl-5 list-disc">
          <li>
            <b>For Job Seekers:</b> Explore thousands of opportunities tailored
            to your skills and interests. Our platform uses advanced algorithms
            to match you with roles that align with your goals. Build a standout
            profile, connect with top companies, and take control of your career
            journey.
          </li>
          <li>
            <b>For Employers:</b> Find exceptional talent quickly and easily.
            Our platform offers smart filters, intuitive search options, and
            candidate recommendations, saving you time and ensuring you hire the
            best.
          </li>
        </ul>
        <h2 class="text-l font-semibold mt-6 mb-2">What Sets Us Apart?</h2>
        <ul class="pl-5 list-disc">
          <li>
            AI-Powered Recommendations: Matchmaking that works for both job
            seekers and recruiters.
          </li>
          <li>
            Personalized Dashboards: Manage applications and listings with ease.
          </li>
          <li>
            Diverse Opportunities: From startups to global enterprises, we cover
            a broad spectrum of industries.
          </li>
          <li>
            Secure & Transparent: We prioritize your data security and provide a
